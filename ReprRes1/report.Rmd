...
```{r all-averaged, fig.height=5, fig.width=7}
...
gm.v1 
```    
```{r all-averaged-with-errorbars, fig.height=5, fig.width=7}
...
```{r goodbad-days-matrix-plot, fig.width=6, fig.height=5}
...
```{r plot-two, fig.width=6, fig.height=5}
