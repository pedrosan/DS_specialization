...
+ **agricultural damage**: _hurricanes_ and _drought_, both in terms of total economic cost and fraction
...
+ **property damage**: in absolute terms _hurricanes_ and _floods_ dominate the economic impact (and here again
...
+ **human fatalities/injuries**: _tornadoes_, _floods_ (including _flash floods_) and _excessive heat_
...
+ Which events have the greatest economic consequences measured by _property damage_,  _crop damage_, 
_total economic damage_.
...
# system.time( data <- read.csv("data/StormData_DL.csv.bz2", colClasses= col.cl$newclass2, nrows=1300000, strip.white=TRUE) )
data <- readRDS("data/df_rapanui_data_as_read.rds")
# str(data)
```
...
```{r define-year-factor, cache=TRUE}
...
+ number of events with given _impact_ (that is fatalities, injuries, property and crop damages, 
...
event in Napa, California, at the end of 200, reported at over $100 Billion. 
