...
fig.height <- 640
fig.res <- 108
png(filename=paste("q4_r",fig.res,".png",sep=""), width=fig.width, height=fig.width, bg="white", res=fig.res)
...
fig.height <- 640
fig.res <- 108
png(filename=paste("q6_r",fig.res,".png",sep=""),width=fig.width,height=fig.width,bg="white",res=fig.res)
# ...
dev.off()
